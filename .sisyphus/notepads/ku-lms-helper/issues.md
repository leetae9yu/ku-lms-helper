...
- The planned selector example used `button:contains("자막")`, which is not valid for `querySelector`; the working implementation must scan interactive elements and match their text/ARIA/title attributes manually.
